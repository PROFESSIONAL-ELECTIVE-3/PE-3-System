...
export default function DepartmentChart({ departmentBreakdown }) {
  return (
    <div className="panel panel-interactive p-5 lg:col-span-2">
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={departmentBreakdown}>
            ...
            <Tooltip contentStyle={{ borderRadius: 10, border: '1px solid var(--line)', fontSize: 12, boxShadow: 'var(--shadow-md)' }} cursor={{ fill: 'var(--sand-deep)' }} />
            <Bar dataKey="count" fill="var(--petrol)" radius={[6, 6, 0, 0]} maxBarSize={44} animationDuration={600} animationEasing="ease-out" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
